...
object Day09 extends AoC:
  ...
  override lazy val answer1: Long = corners.allPairs(using order).drain.area
  override lazy val answer2: Long = corners.allPairs(using order.reverse).findFirst((a, b) => isValid(a, b, perimeter)).area
